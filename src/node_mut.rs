    ...
    pub fn to_enum(&self) -> Result<NodeEnum> {
        unsafe {
            ...
            match self {
                ...
                NodeMut::Expr(n) => Ok(NodeEnum::Expr(n.as_ref().ok_or(err)?.clone())),
                ...
                NodeMut::CreateFunctionStmt(n) => Ok(NodeEnum::CreateFunctionStmt(n.as_ref().ok_or(err)?.clone())),
                ...
                NodeMut::AConst(n) => Ok(NodeEnum::AConst(Box::new(n.as_ref().ok_or(err)?.clone()))),
                ...
                NodeMut::Null(n) => Ok(NodeEnum::Null(n.as_ref().ok_or(err)?.clone())),
