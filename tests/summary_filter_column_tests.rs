...
fn it_finds_unqualified_names() {
    ...
    assert_eq!(filter_columns, vec![FilterColumn { schema_name: None, table_name: None, column: "y".to_string() }, FilterColumn {
        schema_name: None,
        table_name: None,
        column: "z".to_string()
    },]);
...
fn it_finds_qualified_names() {
    ...
    let filter_columns: Vec<FilterColumn> = sorted(result.filter_columns).collect();
    assert_eq!(filter_columns, [FilterColumn { schema_name: None, table_name: Some("x".into()), column: "y".into() }, FilterColumn {
        schema_name: None,
...
fn it_finds_unqualified_names_in_union_query() {
    ...
    let filter_columns: Vec<FilterColumn> = sorted(result.filter_columns).collect();
    assert_eq!(filter_columns, [FilterColumn { schema_name: None, table_name: None, column: "y".into() }, FilterColumn {
        schema_name: None,
        table_name: None,
        column: "z".into()
    },]);
